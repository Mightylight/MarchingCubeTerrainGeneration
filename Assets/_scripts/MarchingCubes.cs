...
public class MarchingCubes
{
        ...
        for (int i = 0; edges[i] != -1; i += 3)
        {
            ...
            //Construct the trianglepoints using the cube corners
             Vector3 trianglePoint1 =
                InterpolateVertex(MarchingCubesTables.cubeCorners[firstEdgePoint1], MarchingCubesTables.cubeCorners[firstEdgePoint2]) + _worldPos;
             Vector3 trianglePoint2 =
                InterpolateVertex(MarchingCubesTables.cubeCorners[secondEdgePoint1], MarchingCubesTables.cubeCorners[secondEdgePoint2]) + _worldPos;
             Vector3 trianglePoint3 =
                InterpolateVertex(MarchingCubesTables.cubeCorners[thirdEdgePoint1], MarchingCubesTables.cubeCorners[thirdEdgePoint2]) + _worldPos;
    ...
    {
        //TODO: Interpolate with noise values
